package src;
/**
 * Importamos el scanner para interactuar con el usuario
 * Creamos la clase Main para ejecutar el código
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            sc.nextLine(); 
            /**
             * Creamos switch que se maneja según la opción asignada por el usario
             */
            try {
                switch (opcion) {
                    case 1:
